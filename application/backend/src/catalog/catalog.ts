...
import type { DatabaseShape, Fee, MovementType, Settings } from "../shared/types.js";
import { resolveMensalidadeDueDay, roundMoney } from "../shared/types.js";
import { refreshPendingMensalidadeSchedule } from "../mensalidades/mensalidades.js";
import { ensureOfficialMensalidadeFees } from "../mensalidades/fee-table.js";
...
export function createMovementType(
  db: DatabaseShape,
  input: { name: string; direction: MovementType["direction"]; description?: string },
  userId: string,
): MovementType {
...
export function updateMovementType(
  db: DatabaseShape,
  typeId: string,
  input: { name?: string; direction?: MovementType["direction"]; description?: string; active?: boolean },
  userId: string,
): MovementType | null {
