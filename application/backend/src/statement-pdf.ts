...
import { fold, parseSignedAmount } from "./csv.js";

const MONEY = /-?\d{1,3}(?:\.\d{3})*,\d{2}/g;
const SKIP = /^(saldo\s+(anterior|atual|do dia|final)|sicredi fone|^sac\b|ouvidoria|periodo de|cooperativa:|associado:|^conta:|aplicacao automatica|rendimento de aplicacao)/;
