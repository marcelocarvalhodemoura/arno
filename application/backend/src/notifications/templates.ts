...
import { dueDayOf, todayISO } from "../mensalidades/mensalidades.js";
import type { DatabaseShape, Member, Transaction } from "../shared/types.js";
import { YOUTH_BRANCHES } from "../shared/types.js";
import type { NotifyKind } from "./notify.js"; // type-only: avoids runtime cycle with notify.ts
...
export function logoFilePath() {
  return join(dirname(fileURLToPath(import.meta.url)), "../../assets/arno_logo.png");
}
