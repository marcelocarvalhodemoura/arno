...
import { aiConfigured, chatJson } from "../shared/openai.js";
...
const ALIASES: Record<CanonicalField, string[]> = {
  ...
  guardianName2: ["responsavel_2", "nome_responsavel_2", "guardian_2"],
  guardianRelationship2: ["parentesco_2", "grau_parentesco_2", "relacao_2"],
  guardianPhone2: ["telefone_responsavel_2", "fone_responsavel_2", "celular_responsavel_2"],
  guardianEmail2: ["email_responsavel_2", "e_mail_responsavel_2"],
