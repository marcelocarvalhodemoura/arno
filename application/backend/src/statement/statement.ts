import type { BranchId, PaymentMethod, TxNature, TxPaymentStatus, TxType } from "../shared/types.js";
import { fold, parseCsv, parseIsoDate, parseSignedAmount, pick } from "../shared/csv.js";
import { matchesMensalidadeAmount } from "../mensalidades/fee-table.js";
